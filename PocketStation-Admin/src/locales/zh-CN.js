export default {
  ...
  'menu.home': '首页',
  'menu.accounts': '经销商账户',
  'menu.accounts.dealer': '人员',
  'menu.QA': 'QA管理',
  'menu.QA.FAQ': 'FAQ管理',
  'menu.QA.question': '互动管理',
  'menu.resource': '开放资源',
  'menu.resource.list': '资源',
  'menu.resource.resource_folder': '资源目录',
  'menu.carousel': '轮播栏',
  'menu.common': '常规设置',
  'menu.common.profile': '轮播栏',
  'menu.recommendtrainings': '推荐培训',
  'menu.recommendtrainings.lesson': '课程',
  'menu.news': '资讯新闻',
  'menu.news.class': '新闻分类',
  'menu.news.news': '新闻管理',
  'navBar.lang': '语言',
  ...
  'app.forms.lesson.add.title': '添加课程',
  'app.forms.resource.add.title': '添加资源',
