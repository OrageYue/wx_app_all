...
@connect(
  ...
  dispatch => ({
    ...
    setTop(params) {
      return dispatch({ type: `${RESOURCE}/news_top`, payload: params });
    },
  })
)
@Form.create()
          ...
          return (
            <div className="editable-row-operations">
              {editable ? (
                ...
                <span>
                  <Button onClick={() => this.setTop(record)} size="small">
      ...
      <PageHeaderLayout title="资讯管理">
        <Card bordered={false}>
          ...
          >
            ...
            <Form.Item {...formItemLayout} label="部门分类">
